...
namespace CmsShoppingCart.Areas.Admin.Controllers
{
    public class ShopController : Controller
    {
        ...
        [HttpPost]
        public string AddNewCategory(string catName)   // uses jquery Ajax
        {
            // Declare id
            string id;
        ...
        public ActionResult AddProduct(ProductVM model, HttpPostedFileBase file)
        {
            ...
            using (Db db = new Db())
            {
                ...
                // category name that was chosen for his product
        ...
        public ActionResult Products(int? page, int? catId)
        {
            ...
            using (Db db = new Db())
            {
                ...
                listOfProductVM = db.Products.ToArray()
                                    ...
                                    .Select(x => new ProductVM(x))              // x is dto
                                    .ToList();
            ...
            // Set pagination
            var onePageOfProducts = listOfProductVM.ToPagedList(pageNumber, 3); // will only contain 3 products max because of the pageSize
        ...
        public void DeleteImage(int id, string imageName)
        {
            ...
            var fullPath2 = Request.MapPath("~/Images/Uploads/Products/" + id.ToString() + "/Gallery/" + imageName);
